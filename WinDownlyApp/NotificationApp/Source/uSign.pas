      ...
      TThread.Synchronize(nil,
        ...
        begin
          ...
          try
            ...
            fnSQLAdd(DM.QTemp1,
              'INSERT INTO tbl_username (id, username, password, email, leveluser)'#13
            ...
            fnSQLParamByName(DM.QTemp1, 'email', mail);
            fnSQLParamByName(DM.QTemp1, 'leveluser', 'User');
            fnExecSQL(DM.QTemp1);

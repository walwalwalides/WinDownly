...
#define ProgName "WinDownly"
#define ProgDocument "Doc_WinDownly"
...
WizardSmallImageFile={#ResourceDir}WinDownly_64_64.bmp
OutputDir={#OutDir}
OutputBaseFilename={#ProgName}_{#ProgShortVersion}_Setup
UninstallDisplayIcon={app}\{#ProgExeName}
SetupIconFile={#ResourceDir}WinDownly.ico
...
[InstallDelete]
Type: files; Name: "{app}\GAlertService.exe"
...
Source: "Actions\Upload.exe"; DestDir: "{app}\Actions"
Source: "WinDownlyShell.exe"; DestDir: "{app}"
Source: "Actions\Download.exe"; DestDir: "{app}\Actions"
...
Filename: "{app}\WinDownlyShell.exe"; Parameters: "/reg"; Flags: nowait postinstall skipifsilent runascurrentuser; 
...
[UninstallRun]
Filename: "{app}\WinDownlyShell.exe"; Parameters: "/unreg";

...
type
  TAction = (aAsk, aDownload, aUpload, aNoSleep, aDisplayOn,
...
const
  ...
  ActionShortNames: array [TAction] of string = ('ask', 'download', 'upload',
...
const
  ActionCaptions: array [TAction] of string = ('Ask', 'Download',
    'Upload', 'No sleep until exit', 'Force display on', 'Deny and notify user',
    'Raise error 0',
    'Raise error 2',
    'Raise access denied',
    'Raise error 32',
